  ...
  return (
    <div className="Header">
      ...
      <div className="Activity">
        <div className="Button-Activity mr-10 hover:bg-[#005B97] hover:text-white text-black font-semibold bg-white bg-opacity-50 backdrop-blur-sm rounded-ful drop-shadow-lg">
          Add Activity
        </div>
      </div>
