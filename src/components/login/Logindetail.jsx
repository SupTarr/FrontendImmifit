        ...
        <div className="max-w-5xl flex flex-col justify-center sm:flex-row mobile:m-10">
          ...
          <form className="flex flex-col justify-center bg-white shadow-md sm:rounded-r-xl px-5 md:max-w-[250px] xl:max-w-[350px] py-5" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              />
              <p id="uidnote" className={(userFocus && user && !validUser) ? "instructions mb-5" : "offscreen"}>
            ...
            <div className="mb-4">
              ...
              />
              <p id="pwdnote" className={passwordFocus && !validPassword ? "instructions mb-5" : "offscreen"}>
                <FontAwesomeIcon icon={faInfoCircle} />
                Invalid password. <br />
            ...
            <div className="flex items-center justify-between align-middle">
              <button className="bg-[#6971f2] hover:bg-[#5960cc] text-white font-bold w-full py-2 rounded focus:outline-none focus:shadow-outline" type="submit">
                Log in
              </button>
            </div>
            ...
            <div className="mt-8 flex flex-1 justify-center">
              <p className="text-sm text-gray-700">Don't have an account? <a className="font-[600]" href='/register'>Sign up</a></p>
            </div>
          </form>
        </div>
      </div>
